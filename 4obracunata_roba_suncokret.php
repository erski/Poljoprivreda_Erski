...
<head>
    ...
    <title>Obračunat sunokret</title>
    ...
    <div class="col-lg-12 container">
        ...
        <table width="100%" id="tabela_center" class="table table-hover">
            ...
            $result1=mysqli_query($con,"SELECT *
                            FROM Obracunata_roba WHERE vrsta_kulture2='suncokret' ORDER BY ime ASC ");
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="update/4obracunataRobaSuncokret.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="vrsta_kulture2">
                                            <option value='<?php echo "$vrsta_kulture2";?>'>Suncokret</option>
                                        </select><br>
                                    </div>
