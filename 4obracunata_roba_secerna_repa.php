...
<head>
    ...
    <title>Obračunata šećerna repa</title>
...
<nav class="col-lg-12">
    ...
    <div class="col-lg-12 container">
        ...
        <h1><b><u>OBRAČUNATA ŠEĆERNA REPA</u></b></h1> <br><br><br>
        ...
        <table width="100%" id="tabela_center" class="table table-hover">
            ...
            $result1=mysqli_query($con,"SELECT *
                            FROM Obracunata_roba WHERE vrsta_kulture2='secerna repa' ORDER BY ime ASC ");
            while($row=mysqli_fetch_array($result1))
            {
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="update/4obracunataRobaSecernaRepa.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="vrsta_kulture2">
                                            <option value='<?php echo "$vrsta_kulture2";?>'>Šećerna repa</option>
                                        </select><br>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" name="submit_update_secerna_repa" value="Posalji" onclick='updateRobe()' class="btn btn-default">Pošalji</button>
                ...
                <?php echo
                '</td> <td id="tdt">'."<a href='delete/4deleteObracunataRoba.php?id=$obracunata_roba_id'><button onclick='brisanjeRobe()' class='btn btn-danger'>DELETE</button> </a>
                                </td> </tr>";
