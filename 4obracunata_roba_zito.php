    ...
    <div class="col-lg-12 container">
        ...
        <table width="100%" id="tabela_center" class="table table-hover">
            ...
            $result1=mysqli_query($con,"SELECT *
                            FROM Obracunata_roba WHERE vrsta_kulture2='zito' ORDER BY ime ASC ");
            while($row=mysqli_fetch_array($result1))
            {
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 align="center" class="modal-title" id="exampleModalLabel">IZMENA PREDATOG ŽITA</h4>
                            </div>
                            <div class="modal-body">
                                <form method="post" action="update/4obracunataRobaZito.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="vrsta_kulture2">
                                            <option value='<?php echo "$vrsta_kulture2";?>'>Žito</option>
                                        </select><br>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" name="submit_update_zito" value="Posalji" onclick='updateRobe()' class="btn btn-default">Pošalji</button>
                ...
                <?php echo
                '</td> <td id="tdt">'."<a href='delete/4deleteObracunataRobaZito.php?id=$obracunata_roba_id'><button onclick='brisanjeRobe()' class='btn btn-danger'>DELETE</button> </a>
                                </td> </tr>";
