        ...
        <div class="container-fluid">
            ...
            <table width="100%" id="tabela_center" class="table table-hover">
                ...
                $result1=mysqli_query($con,"SELECT *
                            FROM Roba WHERE naziv_kulture='kukuruz' ORDER BY mesto_predaje, ime, datum, neto_kolicina ASC ");
                while($row=mysqli_fetch_array($result1))
                {
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="update/3updateRobaKukuruz.php">
                    ...
                    <?php echo
                    '</td> <td id="tdt">'."<a href='delete/3deleteRobaKukuruz.php?id=$r_id'><button onclick='brisanjeRobe()' class='btn btn-danger'>DELETE</button> </a>
                                </td> </tr>";
                    $number++;
                    $number2++;
