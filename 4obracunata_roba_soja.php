    ...
    <div class="col-lg-12 container">
        ...
        <table width="100%" id="tabela_center" class="table table-hover">
            ...
            $result1=mysqli_query($con,"SELECT *
                            FROM Obracunata_roba WHERE vrsta_kulture2='soja' ORDER BY ime ASC ");
            while($row=mysqli_fetch_array($result1))
            {
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="update/4obracunataRobaSoja.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="vrsta_kulture2">
                                            <option value='<?php echo "$vrsta_kulture2";?>'>Soja</option>
                                        </select><br>
                                    </div>
                ...
                <?php echo
                '</td> <td id="tdt">'."<a href='delete/4deleteObracunataRobaSOJA.php?id=$obracunata_roba_id'><button onclick='brisanjeRobe()' class='btn btn-danger'>DELETE</button> </a>
                                </td> </tr>";
