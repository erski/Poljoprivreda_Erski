        ...
        <div class="container-fluid">
            ...
            <table width="100%" id="tabela_center" class="table table-hover">
                ...
                $result1=mysqli_query($con,"SELECT *
                            FROM Roba WHERE naziv_kulture='secerna repa' ORDER BY mesto_predaje, ime, datum DESC ");
                while($row=mysqli_fetch_array($result1))
                {
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 align="center" class="modal-title" id="exampleModalLabel">IZMENA PREDATE ŠEĆERNE REPE</h4>
                                </div>
                                <div class="modal-body">
                                    <form method="post" action="update/3updateRobaSecernaRepa.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="vrsta">
                                                <option value="secerna repa">Šecerna repa</option>
                                            </select><br>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" name="submit_update_secernaRepa" value="Posalji" onclick='updateRobe()' class="btn btn-default">Pošalji</button>
                    ...
                    <?php echo
                    '</td> <td id="tdt">'."<a href='delete/3deleteRobaSecernaRepa.php?id=$r_id'><button onclick='brisanjeRobe()' class='btn btn-danger'>DELETE</button> </a>
                                </td> </tr>";
                    $number++;
                    $number2++;
